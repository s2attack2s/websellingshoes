...
var Common = (function () {
    ...
    var SaveSuccess = function (res, callback, callbackError) {
        try {
            ...
            if (res.Code === 200) {
                Notification.Alert(MSG_NO.CONFIRM_AFTER_SAVE, callback);
            }
    ...
    var DeleteSuccess = function (res, callback, callbackError) {
        try {
            ...
            if (res.Code === 200) {
                Notification.Alert(MSG_NO.CONFIRM_AFTER_DELETE, callback);
            }
    ...
    var Trans = function (text) {
        var langText = {
            'vi': {
                ...
                'Edit series of blogs': 'Chỉnh sửa nhóm blog',
                'Create series of blogs': 'Tạo nhóm blog',
                'Server File Manager': 'Quản lý file',
                'Show more': 'Xem thêm'
            },
            'en': {
                'Add': 'Add',
                ...
                'Edit series of blogs': 'Edit series of blogs',
                'Create series of blogs': 'Create series of blogs',
                'Server File Manager': 'Server File Manager',
                'Show more': 'Show more'
            }
        };
        if (!StringModule.IsNullOrEmpty(langText[lang][text])) {
            return langText[lang][text];
        }
        return text;
    };
